...
<table style='background-color:#fff;' width='450' border='0' align='center' cellpadding='0' cellspacing='0'>
  <tr>
    <td style='text-align:center;'><img src='http://nuqat.me/img/etickets/topheader.png' width='238' height='119' /></td>
  </tr>
  <tr>
    <td style='text-align:center;padding-top:10px;'><img src='http://nuqat.me/img/etickets/nuqatheader.png' width='159' height='174' /></td>
  </tr>
  <tr>
    <td height='40'>&nbsp;</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>FULL NAME: ";

	$email_message .= "Full Name: ".$row_register['FName']." ".$row_register['LName']."</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>EMAIL: ";
	
	$email_message .= "Email: ".$row_register['email']."</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>MOBILE: ";
	
	$email_message .= "Mobile: ".$row_register['Mobile']."</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>PACKAGE: ";
	
	if ($row_register['Package'] == 55000) {
		$email_message .= "Package: 3 days Lectures + 2 workshops = 550$ \r\n";
	} elseif ($row_register['Package'] == 38500) {
		$email_message .= "Package: 3 days + 1 workshop = 385$ </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>TRANSACTION REFERENCE: ";
	}  elseif ($row_register['Package'] == 27500) {
		$email_message .= "Package: 3 days Lectures = 275$ </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>TRANSACTION REFERENCE: ";
	}  elseif ($row_register['Package'] == 11000) {
		$email_message .= "Package: Day 1 Lectures = 110$ </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>TRANSACTION REFERENCE: ";
	}  elseif ($row_register['Package'] == 11000) {
		$email_message .= "Package: Day 2 Lectures = 110$ </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>TRANSACTION REFERENCE: ";
	}  elseif ($row_register['Package'] == 11000) {
		$email_message .= "Package: Day 3 Lectures = 110$ </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>TRANSACTION REFERENCE: ";
	}
	$email_message .= "Transaction Reference(Important): ".$row_register['merchTxnRef']."</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>MORNING WORKSHOP: ";
	if ($row_register['MorningW'] <> "") {
		$email_message .= "Morning Workshop: ".$row_register['MorningW']."</td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>AFTERNOON WORKSHOP: ";
	} else {
		$email_message .= "Morning Workshop: # </td>
  </tr>
  <tr>
    <td style='padding:5px 0 5px 50px;font-family: 'nuqat';'>AFTERNOON WORKSHOP: ";
	}
		
	if ($row_register['AfternoonW'] <> "") {
		$email_message .= "Afternoon Workshop: ".$row_register['AfternoonW']."</td>
  </tr>
  <tr>
    <td height='100'>&nbsp;</td>
  </tr>
  <tr>
    <td style='text-align:center;font-family: 'nuqat';'>PLEASE PRINT OUT YOUR E-TICKET FOR REGISTRATION</td>
		...
		$email_message .= "Afternoon Workshop: # </td>
  </tr>
  <tr>
    <td height='100'>&nbsp;</td>
  </tr>
...
header("Location: regconf.php?merchTxnRef=".$row_register['merchTxnRef']);
exit();
