<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form action="holdvalue.php" method="post">
...
<input name="returnURL" size="65" style="visibility:hidden;" value="http://nuqat.me/paymentTestForm.php?action=py?" maxlength="250"/></div>
      ...
      <table width="400" id="AfternoonW">
        <tr>
          ...
          <label>
            ...
            WTD MAG (21-22) only</label><br /></td>
        </tr>
      </table></div>    
    </td>
  </tr>
